                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Padding(
                                    ...
                                    child: AutoSizeText(
                                      FFLocalizations.of(context).getText(
                                        'xukko6r5' /* Welcome to elearny ! We're thr... */,
                                      ),
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Padding(
                                    ...
                                    child: AutoSizeText(
                                      FFLocalizations.of(context).getText(
                                        'xmxwf0xb' /* Discover a world of knowledge ... */,
                                      ),
                                      textAlign: TextAlign.center,
                                      style: FlutterFlowTheme.of(context)
                                          .labelLarge
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Padding(
                                    ...
                                    child: AutoSizeText(
                                      FFLocalizations.of(context).getText(
                                        'utj0g2lm' /* It's time to get started! Dive... */,
                                      ),
                                      textAlign: TextAlign.center,
                                      style: FlutterFlowTheme.of(context)
                                          .labelLarge
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Padding(
                                          ...
                                          child: Text(
                                            FFLocalizations.of(context).getText(
                                              'pxgyd0d4' /* Sign up below in order to get ... */,
                                            ),
                                            style: FlutterFlowTheme.of(context)
                                                .titleSmall
                                                .override(
